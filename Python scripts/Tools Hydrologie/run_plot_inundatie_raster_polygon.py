...
In deze script wordt een raster/polygon geplot. Hierbij is gebruik gemaakt van inundatiediepte data.
...
class paths():
    ...
    shp_insteek     = os.path.join(root,'Data','BR_VS_Insteekvlak.shp')  
    raster_file     = os.path.join(root,'Data',"waterdepth.tif") # zie workflow "Sobek 2 inundatie"
    file_txt        = os.path.join(root,'Data',"MM_INNUN.txt") # zie workflow "Sobek 2 inundatie"
